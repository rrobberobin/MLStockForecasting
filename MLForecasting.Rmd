...
data <- fread("Data/OriginalData/FundamentalsQuarterly.csv", nThread=getDTthreads(verbose), select=NULL)
...
crucialNames = c("gvkey", "fdateYQ", "quarterlyReturns", "quarterlyVolatility", "MktCap", "Split")

dummyNames = c("naics", "loc", "city", "acctstdq", "compstq")
...
newVariableNames = c(crucialNames, dummyNames, numericalNames, laggedVolAndRetNames, labelNames)
